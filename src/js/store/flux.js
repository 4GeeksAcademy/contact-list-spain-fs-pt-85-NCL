const getState = ({ getStore, getActions, setStore }) => { 
    return {
        ...
        actions: {
            createUser: () => {
                fetch("https://playground.4geeks.com/contact/agendas/nachocordoba13", {
                    method: "POST",
            ...
            getInfoContacts: () => {
                fetch("https://playground.4geeks.com/contact/agendas/nachocordoba13/contacts", {
                    method: "GET"
                })
                    .then((response) => {
            ...
            deleteContact: (id) => {
                fetch(`https://playground.4geeks.com/contact/agendas/nachocordoba13/contacts/${id}`, {
                    method: "DELETE",
                })
                    .then((response) => {
